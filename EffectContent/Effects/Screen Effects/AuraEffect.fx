...
float lightAttenuationFactor = 0.3f;	// The light/distance attenuation - we'll divide the pixel/light source distance by this. ; Default = 1.8f
...
float4 LightingShader(float2 texCoord: TEXCOORD0) : COLOR
{
	...
	//float3 pixelLightComponents = { 255.0, 0.0, 0.0 };
	...
	//float2 tmpLocation = {200.0, 200.0};
