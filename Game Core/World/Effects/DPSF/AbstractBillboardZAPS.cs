...
{
    /// <summary>
    /// A simple billboard superclass for all DPSF particle systems - one to bind them, one to rule them and all that [Gears].
    /// </summary>
    public abstract class AbstractBillboardZAPS : DefaultSprite3DBillboardParticleSystem
    {
        ...
        /// <summary>
        /// If true then this ZAPS is bound to the parent ACE location. NOTE: If you are not using a AbstractLocation2DZAPS, then you will have to manage Location.Y yourself!
        /// </summary>
        public bool IsBoundToParentACELocation { get; set; }
        ...
        public override void AutoInitialize(GraphicsDevice cGraphicsDevice, ContentManager cContentManager, SpriteBatch cSpriteBatch)
        {
            if (!this.IsInitialized)
            {
                ...
                InitializeSpriteParticleSystem(cGraphicsDevice, cContentManager, ParticleBudgetTotal, ParticleBudgetTotal,
                                                     ParticleTexture);
                Name = "BillboardZAPS";
        ...
        public virtual void InitializeZAPSParticle(DefaultSprite3DBillboardParticle cParticle)
        {
