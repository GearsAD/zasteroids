...
namespace DPSF.ParticleSystems
{
    ...
    class ExplosionFireSmokeParticleSystem : DefaultTexturedQuadTextureCoordinatesParticleSystem
    {
        ...
        {
            InitializeTexturedQuadParticleSystem(graphicsDevice, contentManager, 2000, 8000,
        ...
        public void LoadEvents()
        {
            ...
            // Setup the emitter
            Vector3 modifiedLocation = new Vector3();
            modifiedLocation = Location;
            modifiedLocation.Y += 12;

            Location = modifiedLocation;
            
            Emitter.PositionData.Position = Location; //new Vector3(0, 50, 0);
        ...
        public void InitializeParticleExplosion(DefaultTextureQuadTextureCoordinatesParticle particle)
        {
            ...
            particle.Position = Emitter.PositionData.Position ; //+ new Vector3(RandomNumber.Next(-2, 2), RandomNumber.Next(-2, 2), RandomNumber.Next(-2, 2));
