...
namespace ZitaAsteria.World.ShaderEffects
{
    ...
    /// </summary>
    public class AuraEffectShader : ShaderEffect
    {
        /// <summary>
        ...
        public override void Initialize()
        {
            ...
            //lightColour = new Vector3(255.0f, 0.0f, 0.0f);
            //Can add ambient light in here...
            ambientLight = new Vector3(1.0f, 1.0f, 1.0f) * 0.1f;

            //Load the effect.
            this.hlslEffect                     = WorldContent.effectContent.auraEffect;
